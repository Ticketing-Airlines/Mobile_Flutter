          ...
          child: ListView(
            ...
            children: [
              ...
              _drawerItem(
                ...
                label: 'Manage',
                onTap: () => _navReplace(const UserManagePage()),
              ),
              _drawerItem(
                icon: Icons.info,
                label: 'Travel Info',
...
class UserManageMainCard extends StatefulWidget {
  final IconData icon;
  final String title;
  final Color color;
  final VoidCallback? onTap;

  const UserManageMainCard({
    super.key,
    required this.icon,
    required this.title,
    required this.color,
  ...
  @override
  State<UserManageMainCard> createState() => _UserManageMainCardState();
}

class _UserManageMainCardState extends State<UserManageMainCard> {
  bool _pressed = false;
...
// BELOW section cards
class UserManageSubCard extends StatefulWidget {
  final IconData icon;
  final String title;
  ...
  @override
  State<UserManageSubCard> createState() => _UserManageSubCardState();
}

class _UserManageSubCardState extends State<UserManageSubCard> {
  bool _pressed = false;
