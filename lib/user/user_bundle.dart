...
class UserFlightBundlesPage extends StatefulWidget {
  ...
  @override
  State<UserFlightBundlesPage> createState() => _FlightBundlesPageState();
}

class _FlightBundlesPageState extends State<UserFlightBundlesPage> {
